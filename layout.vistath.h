...
static struct layout layouts[NumLayouts] = {
    ...
    [Simple] = {keys_simple, "chinese", "simple", true},
    ...
    [LandscapeSpecial] = {keys_landscape_special, "chinese", "landscapespecial",
                          true},
...
static struct key keys_full[] = {
    ...
    {"Prt Sc", "Prt Sc", 1.0, Code, KEY_PRINT, .scheme = 1},
...
static struct key keys_cyrillic_simple[] = {
    {"1", "!", 1.0, Code, KEY_1},
    {"2", "\"", 1.0, Code, KEY_2},
    {"3", "№", 1.0, Code, KEY_3},
    {"4", ";", 1.0, Code, KEY_4},
